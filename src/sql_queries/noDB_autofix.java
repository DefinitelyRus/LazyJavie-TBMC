...
public class noDB_autofix {
	public static String[] get(String mode) {
		...
		"create table lazyjavie.members (id int not null auto_increment, userid varchar(255), userpass varchar(255), points int default 0, primary key(id));",
		"create table lazyjavie.shop (itemid int not null auto_increment, itemname varchar(24), price int, quantity int, itemdesc varchar(250), primary key(itemid));",
		"create table lazyjavie.cmdlog (id int not null auto_increment,  userquery varchar(255), primary key(id));",
		"create table lazyjavie.roleblacklist ( id int not null auto_increment, rolename varchar(255), primary key(id));",
